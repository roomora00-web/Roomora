content = """{% extends "bookings/base_checkout.html" %}
{% load static %}
...
<form method="post" action="{% url 'bookings:acknowledge_house_rules' %}" class="w-full relative">
  ...
  <div class="absolute top-0 inset-x-0 h-[500px] bg-gradient-to-b from-[#111111]/5 via-[#111111]/[0.02] to-transparent -z-10 pointer-events-none"></div>
  <!-- Abstract Shapes for Premium Feel -->
  <div class="absolute top-0 right-0 w-96 h-96 bg-[#3B82F6]/5 rounded-full blur-3xl -z-10 pointer-events-none translate-x-1/3 -translate-y-1/3"></div>
  <div class="absolute top-40 left-0 w-72 h-72 bg-[#10B981]/5 rounded-full blur-3xl -z-10 pointer-events-none -translate-x-1/2"></div>
  ...
  <div class="px-4 py-12 sm:px-6 lg:px-12 max-w-[1400px] mx-auto w-full">
    ...
    <div class="mb-12 animate-fade-up" style="animation-delay: 0.1s;">
      ...
      <p class="mt-4 text-[17px] font-medium leading-relaxed text-[#111111]/60 max-w-2xl">Confirm the property details, amenities, and host expectations before reserving your room.</p>
    </div>
    ...
    <div class="flex flex-col-reverse lg:flex-row gap-10 xl:gap-16 items-start">
      ...
      <div class="w-full lg:w-[65%] flex flex-col gap-10 pb-20">
        ...
        <section class="group animate-fade-up" style="animation-delay: 0.2s;">
          <div class="bg-white/80 backdrop-blur-xl border border-black/5 rounded-[32px] p-8 sm:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] relative overflow-hidden">
            <div class="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-gray-100 to-transparent rounded-bl-full opacity-50 -z-10 transition-transform duration-700 group-hover:scale-125"></div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 py-6 border-y border-black/5">
              <div>
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-up" style="animation-delay: 0.3s;">
          ...
          <div class="bg-white/80 backdrop-blur-xl border border-black/5 rounded-[32px] p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-300 flex flex-col justify-between group">
            <div>
              <div class="w-12 h-12 rounded-[16px] bg-[#111111]/5 flex items-center justify-center text-[#111111] mb-6 transition-transform duration-300 group-hover:scale-110">
          ...
          <!-- Safety Bento -->
          <div class="bg-[#ECFDF5]/60 backdrop-blur-xl border border-[#059669]/10 rounded-[32px] p-8 shadow-[0_8px_30px_rgba(5,150,105,0.04)] hover:shadow-[0_20px_40px_rgba(5,150,105,0.08)] transition-all duration-300 group">
            <div class="flex items-center justify-between mb-6">
              <div class="w-12 h-12 rounded-[16px] bg-white flex items-center justify-center text-[#059669] shadow-sm transition-transform duration-300 group-hover:scale-110">
            ...
            <ul class="space-y-4">
              {% if property.security_personnel %}
                <li class="flex items-center gap-3 text-[15px] font-medium text-[#111111]/80"><svg class="text-[#059669] shrink-0" width="18" height="18" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg> 24/7 Security Personnel</li>
              {% endif %}
              {% if property.cctv %}
                <li class="flex items-center gap-3 text-[15px] font-medium text-[#111111]/80"><svg class="text-[#059669] shrink-0" width="18" height="18" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg> CCTV Surveillance</li>
              {% endif %}
              {% if property.gated_community %}
                <li class="flex items-center gap-3 text-[15px] font-medium text-[#111111]/80"><svg class="text-[#059669] shrink-0" width="18" height="18" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg> Gated Community</li>
              {% endif %}
              {% if property.fire_safety_compliance %}
                <li class="flex items-center gap-3 text-[15px] font-medium text-[#111111]/80"><svg class="text-[#059669] shrink-0" width="18" height="18" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg> Fire Safety Compliant</li>
              {% endif %}
              {% if not property.security_personnel and not property.cctv and not property.gated_community %}
                <li class="text-[15px] font-medium text-[#111111]/70 bg-white/60 p-4 rounded-xl border border-black/5">Standard neighborhood security protocols are observed here.</li>
              {% endif %}
            </ul>
          </div>
        </section>
        ...
        <section class="animate-fade-up" style="animation-delay: 0.4s;">
          <div class="bg-white/80 backdrop-blur-xl border border-black/5 rounded-[32px] p-8 sm:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <div class="flex flex-col gap-4">
                  ...
                  <div class="bg-[#F9FAFB] p-5 rounded-[20px] border border-black/5 flex justify-between items-center hover:bg-[#F3F4F6] transition-colors">
                  ...
                  <div class="bg-[#F9FAFB] p-5 rounded-[20px] border border-black/5 hover:bg-[#F3F4F6] transition-colors">
                    <div class="font-extrabold text-[15px] text-[#111111] mb-2">Visitor Policy</div>
            ...
            <div class="mt-8 pt-8 border-t border-black/5">
              <div class="bg-[#FFFAF0]/80 border border-[#FDE68A]/50 rounded-[24px] p-6 sm:p-8 flex items-start gap-5 shadow-sm">
                <div class="w-12 h-12 shrink-0 rounded-[16px] bg-[#FEF3C7] flex items-center justify-center text-[#D97706] shadow-inner">
      ...
      <div class="w-full lg:w-[35%] lg:sticky lg:top-[100px] z-10 animate-fade-up" style="animation-delay: 0.5s;">
        <div class="bg-white/95 backdrop-blur-3xl rounded-[32px] border border-black/10 shadow-[0_24px_50px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-[0_32px_60px_rgba(0,0,0,0.1)]">
          ...
          <div class="p-4 pb-0 relative">
              ...
              {% if room and room.images.exists %}
                {% for r_img in room.images.all %}
                  <div class="shrink-0 snap-center w-full relative">
                    <img src="{{ r_img.image.url }}" alt="{{ r_img.get_image_type_display }}" class="w-full h-[240px] object-cover rounded-[20px] shadow-sm">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-[20px] pointer-events-none"></div>
                  </div>
                {% endfor %}
              {% elif property.main_image %}
                <div class="shrink-0 snap-center w-full relative">
                  <img src="{{ property.main_image.url }}" alt="{{ property.title }}" class="w-full h-[240px] object-cover rounded-[20px] shadow-sm">
                  <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-[20px] pointer-events-none"></div>
                </div>
              {% endif %}
            </div>
            ...
            {% if room %}
              <div class="absolute bottom-8 left-8 bg-white/95 backdrop-blur-md px-4 py-1.5 rounded-full shadow-lg text-[13px] font-extrabold text-[#111111] ring-1 ring-black/5">
          ...
          <div class="px-8 py-6 flex flex-col gap-6">
            ...
            <div>
              <div class="flex justify-between items-start mb-2">
                <div class="text-[20px] font-extrabold text-[#111111] leading-tight">{{ room.room_type.room_type_name }}</div>
              ...
              <div class="flex flex-wrap gap-2 mt-4">
                <span class="inline-flex items-center gap-1.5 bg-[#F5F5F5] border border-black/5 rounded-[12px] px-3 py-2 text-[13px] font-bold text-[#111111]/80 shadow-sm">
            ...
            <label class="block cursor-pointer group mt-2 relative">
              <div class="bg-[#F5F5F5] rounded-[24px] p-5 transition-all duration-300 border-[2.5px] border-transparent hover:bg-[#E5E5E5] group-has-[:checked]:border-[#111111] group-has-[:checked]:bg-white group-has-[:checked]:shadow-md relative z-10">
                <div class="flex items-start gap-4">
                  <div class="relative flex items-center justify-center mt-0.5">
                    <input type="checkbox" id="ackCheckbox" name="rules_acknowledged" value="yes" required class="peer h-6 w-6 appearance-none rounded-[8px] border-[2.5px] border-[#111111]/20 bg-white checked:border-[#111111] checked:bg-[#111111] focus:ring-0 focus:outline-none transition-all duration-200 cursor-pointer">
                  ...
                  <span class="text-[14px] leading-snug text-[#111111]/80 font-bold select-none group-has-[:checked]:text-[#111111] transition-colors">
            ...
            <!-- Submit Button -->
            <button type="submit" id="ackSubmitBtn" disabled class="relative w-full flex items-center justify-center gap-3 px-8 py-[22px] bg-[#111111] text-white rounded-[24px] font-extrabold text-[17px] transition-all duration-300 hover:bg-[#222222] hover:shadow-[0_20px_40px_rgba(17,17,17,0.25)] hover:-translate-y-1 disabled:opacity-40 disabled:hover:bg-[#111111] disabled:hover:translate-y-0 disabled:shadow-none disabled:cursor-not-allowed overflow-hidden group">
