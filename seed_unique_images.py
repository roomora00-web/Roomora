"""
Seed Script: Unique Image Assignment Across 7 Regional Hostels
Ensures 100% UNIQUE property photos (exterior, interior) and UNIQUE room photos (bedroom, bathroom, kitchen).
No duplicate images across properties or room types.
Maintains exact room slot principle (1-in-a-room = 1 bed = 1 slot left).
"""
import os
import sys
import shutil
...
add_pi(p1, cp("HOSTELS/images (18).jpeg", "HST-ACC-MLH-001_ext_main.jpeg", MEDIA_P), "EXTERIOR", "Front Exterior", True, 1)
add_pi(p1, cp("HOSTELS/images (7).jpeg",  "HST-ACC-MLH-001_ext_2.jpeg",    MEDIA_P), "EXTERIOR", "Hostel Gated Entrance", False, 2)
add_pi(p1, cp("HOSTELS/images (17).jpeg", "HST-ACC-MLH-001_int_1.jpeg",    MEDIA_P), "INTERIOR", "Clean Interior Corridor", False, 3)
...
add_rt_option(p1, "Single Room (1 in a Room)", "SEMESTER_BASED", "SINGLE", 1, "S101",
              ...
              img1=cp("HOSTELS/images (19).jpeg", "HST-ACC-MLH-001_rm_S_bed.jpeg", MEDIA_R),
              img2=cp("bathrooms/images (1).jpeg", "HST-ACC-MLH-001_rm_S_bath.jpeg", MEDIA_R))
...
add_rt_option(p1, "Double Room (2 in a Room)", "SEMESTER_BASED", "DOUBLE", 2, "D201",
              ...
              img1=cp("HOSTELS/images (1).jpeg", "HST-ACC-MLH-001_rm_D_bed.jpeg", MEDIA_R),
              img2=cp("kitchen/images (1).jpeg", "HST-ACC-MLH-001_rm_D_kit.jpeg", MEDIA_R))
...
add_pi(p2, cp("HOSTELS/images (8).jpeg",  "HST-ACC-PRH-002_ext_main.jpeg", MEDIA_P), "EXTERIOR", "Iconic Pink Exterior", True, 1)
add_pi(p2, cp("HOSTELS/images (13).jpeg", "HST-ACC-PRH-002_ext_2.jpeg",    MEDIA_P), "EXTERIOR", "Side View & Courtyard", False, 2)
add_pi(p2, cp("HOSTELS/images (16).jpeg", "HST-ACC-PRH-002_int_lounge.jpeg", MEDIA_P), "INTERIOR", "Student Lounge", False, 3)
...
add_rt_option(p2, "Single Room — Girls Only", "SEMESTER_BASED", "SINGLE", 1, "S101",
              ...
              img1=cp("HOSTELS/images (14).jpeg", "HST-ACC-PRH-002_rm_S_bed.jpeg", MEDIA_R),
              img2=cp("bathrooms/images (2).jpeg", "HST-ACC-PRH-002_rm_S_bath.jpeg", MEDIA_R))
...
add_rt_option(p2, "Double Room — Girls Only", "SEMESTER_BASED", "DOUBLE", 2, "D201",
              ...
              img1=cp("HOSTELS/images (9).jpeg", "HST-ACC-PRH-002_rm_D_bed.jpeg", MEDIA_R),
              img2=cp("kitchen/images (2).jpeg", "HST-ACC-PRH-002_rm_D_kit.jpeg", MEDIA_R))
...
add_pi(p3, cp("HOSTELS/images (2).jpeg",  "HST-KMS-AMH-003_ext_main.jpeg", MEDIA_P), "EXTERIOR", "Stone Clad Exterior", True, 1)
add_pi(p3, cp("HOSTELS/images (12).jpeg", "HST-KMS-AMH-003_ext_2.jpeg",    MEDIA_P), "EXTERIOR", "Side Balconies", False, 2)
add_pi(p3, cp("HOSTELS/images (20).jpeg", "HST-KMS-AMH-003_int_study.jpeg", MEDIA_P), "INTERIOR", "Study Nook", False, 3)
...
add_rt_option(p3, "Double Room (2 in a Room)", "SEMESTER_BASED", "DOUBLE", 2, "D101",
              ...
              img1=cp("HOSTELS/images (5).jpeg", "HST-KMS-AMH-003_rm_D_bed.jpeg", MEDIA_R),
              img2=cp("bathrooms/images (3).jpeg", "HST-KMS-AMH-003_rm_D_bath.jpeg", MEDIA_R))
...
add_rt_option(p3, "Triple Room (3 in a Room)", "SEMESTER_BASED", "TRIPLE", 3, "T301",
              ...
              img1=cp("HOSTELS/images.jpeg", "HST-KMS-AMH-003_rm_T_bed.jpeg", MEDIA_R),
              img2=cp("kitchen/images (3).jpeg", "HST-KMS-AMH-003_rm_T_kit.jpeg", MEDIA_R))
...
add_pi(p4, cp("HOSTELS/images (10).jpeg", "HST-WST-TKH-004_ext_main.jpeg", MEDIA_P), "EXTERIOR", "Ocean View Exterior", True, 1)
add_pi(p4, cp("compound house/images (1).jpeg", "HST-WST-TKH-004_ext_2.jpeg", MEDIA_P), "EXTERIOR", "Gated Compound", False, 2)
add_pi(p4, cp("APARTMENT/greenviews-residential-social-areas.webp", "HST-WST-TKH-004_int_social.jpeg", MEDIA_P), "INTERIOR", "Social Lounge", False, 3)
...
add_rt_option(p4, "Executive Single Room (Ensuite)", "SEMESTER_BASED", "SINGLE", 1, "E101",
              ...
              img1=cp("HOSTELS/images (15).jpeg", "HST-WST-TKH-004_rm_E_bed.jpeg", MEDIA_R),
              img2=cp("bathrooms/images (4).jpeg", "HST-WST-TKH-004_rm_E_bath.jpeg", MEDIA_R))
...
add_rt_option(p4, "Standard Double Room", "SEMESTER_BASED", "DOUBLE", 2, "D201",
              ...
              img1=cp("HOSTELS/images (3).jpeg", "HST-WST-TKH-004_rm_D_bed.jpeg", MEDIA_R),
              img2=cp("kitchen/images (4).jpeg", "HST-WST-TKH-004_rm_D_kit.jpeg", MEDIA_R))
...
add_pi(p5, cp("compound house/images (12).jpeg", "HST-CTR-CCH-005_ext_main.jpeg", MEDIA_P), "EXTERIOR", "Main Entrance", True, 1)
add_pi(p5, cp("villa/images (1).jpeg",          "HST-CTR-CCH-005_ext_2.jpeg",    MEDIA_P), "EXTERIOR", "Courtyard", False, 2)
add_pi(p5, cp("APARTMENT/images (21).jpeg",     "HST-CTR-CCH-005_int_1.jpeg",    MEDIA_P), "INTERIOR", "Recreation Hall", False, 3)
...
add_rt_option(p5, "Single Room (1 in a Room)", "SEMESTER_BASED", "SINGLE", 1, "S101",
              ...
              img1=cp("HOSTELS/images (4).jpeg", "HST-CTR-CCH-005_rm_S_bed.jpeg", MEDIA_R),
              img2=cp("bathrooms/images (5).jpeg", "HST-CTR-CCH-005_rm_S_bath.jpeg", MEDIA_R))
...
add_rt_option(p5, "Double Room (2 in a Room)", "SEMESTER_BASED", "DOUBLE", 2, "D201",
              ...
              img1=cp("APARTMENT/images (1).jpeg", "HST-CTR-CCH-005_rm_D_bed.jpeg", MEDIA_R),
              img2=cp("kitchen/images (6).jpeg", "HST-CTR-CCH-005_rm_D_kit.jpeg", MEDIA_R))
...
add_pi(p6, cp("HOSTELS/images (11).jpeg", "HST-NTH-UDH-006_ext_main.jpeg", MEDIA_P), "EXTERIOR", "Savannah Oasis Front", True, 1)
add_pi(p6, cp("compound house/images.jpeg", "HST-NTH-UDH-006_ext_2.jpeg", MEDIA_P), "EXTERIOR", "Spacious Compound", False, 2)
add_pi(p6, cp("villa/images (2).jpeg", "HST-NTH-UDH-006_int_1.jpeg", MEDIA_P), "INTERIOR", "Reception & Lobby", False, 3)
...
add_rt_option(p6, "Double Room (2 in a Room)", "SEMESTER_BASED", "DOUBLE", 2, "D101",
              ...
              img1=cp("APARTMENT/images (2).jpeg", "HST-NTH-UDH-006_rm_D_bed.jpeg", MEDIA_R),
              img2=cp("bathrooms/images.jpeg", "HST-NTH-UDH-006_rm_D_bath.jpeg", MEDIA_R))
...
add_rt_option(p6, "Triple Room (3 in a Room)", "SEMESTER_BASED", "TRIPLE", 3, "T301",
              ...
              img1=cp("APARTMENT/images (3).jpeg", "HST-NTH-UDH-006_rm_T_bed.jpeg", MEDIA_R),
              img2=cp("kitchen/images.jpeg", "HST-NTH-UDH-006_rm_T_kit.jpeg", MEDIA_R))
...
add_pi(p7, cp("villa/images.jpeg", "HST-VLT-HOH-007_ext_main.jpeg", MEDIA_P), "EXTERIOR", "Volta Heights Exterior", True, 1)
add_pi(p7, cp("compound house/gettyimages-1232722820-1024x1024.jpg", "HST-VLT-HOH-007_ext_2.jpeg", MEDIA_P), "EXTERIOR", "Secure Perimeter", False, 2)
add_pi(p7, cp("APARTMENT/066e1246c0026a-6-unit-apartment-block-for-sale-adenta-adenta-municipal-greater-accra.jpeg", "HST-VLT-HOH-007_int_1.jpeg", MEDIA_P), "INTERIOR", "Main Building Corridor", False, 3)
...
add_rt_option(p7, "Executive Single Room (Ensuite)", "SEMESTER_BASED", "SINGLE", 1, "E101",
              ...
              img1=cp("APARTMENT/images (4).jpeg", "HST-VLT-HOH-007_rm_E_bed.jpeg", MEDIA_R),
              img2=cp("bathrooms/0e2d1f770d15710e0ae27b77d61175014c2acb4d.jpeg", "HST-VLT-HOH-007_rm_E_bath.jpeg", MEDIA_R))
...
add_rt_option(p7, "Double Room (2 in a Room)", "SEMESTER_BASED", "DOUBLE", 2, "D201",
              ...
              img1=cp("APARTMENT/images (5).jpeg", "HST-VLT-HOH-007_rm_D_bed.jpeg", MEDIA_R),
              img2=cp("kitchen/735824101.jpg", "HST-VLT-HOH-007_rm_D_kit.jpeg", MEDIA_R))
...
# ─── VERIFICATION AUDIT ────────────────────────────────────────────────
print("\n" + "="*70)
print("100% UNIQUE IMAGE & SLOT AUDIT")
print("="*70)

cur.execute("""
    SELECT p.property_code, p.title, pi.image, pi.image_type
    FROM properties p
...
print(f"\nTotal Property Images: {len(p_imgs)}")
p_img_urls = set()
for r in p_imgs:
    p_img_urls.add(r[2])
    print(f"[{r[0]}] {r[1]} -> {r[3]}: {r[2]}")

print(f"Unique Property Image URLs count: {len(p_img_urls)} of {len(p_imgs)}")

cur.execute("""
    SELECT p.property_code, rt.room_type_name, pri.image, pri.image_type
    FROM properties p
    JOIN room_types rt ON rt.accommodation_property_id=p.id
    JOIN rooms rm ON rm.room_type_id=rt.id
    JOIN properties_roomimage pri ON pri.room_id=rm.id
    ORDER BY p.id, rt.id;
""")
r_imgs = cur.fetchall()

print(f"\nTotal Room Images: {len(r_imgs)}")
r_img_urls = set()
for r in r_imgs:
    r_img_urls.add(r[2])
    print(f"[{r[0]}] {r[1]} -> {r[3]}: {r[2]}")

print(f"Unique Room Image URLs count: {len(r_img_urls)} of {len(r_imgs)}")

if len(p_img_urls) == len(p_imgs) and len(r_img_urls) == len(r_imgs):
    print("\n🎉 ZERO DUPLICATE IMAGES DETECTED! ALL 7 PROPERTIES & ALL ROOMS HAVE 100% UNIQUE PHOTOS!")
else:
    print("\n⚠️ WARNING: Some images overlap.")
